...
static void ShowDemoWindowWidgets()
{
    ...
    if (ImGui::TreeNode("Selectables"))
    {
        ...
        if (ImGui::TreeNode("Selection EngineState: Single Selection"))
        {
        ...
        if (ImGui::TreeNode("Selection EngineState: Multiple Selection"))
        {
    ...
    if (ImGui::TreeNode("Plots Widgets"))
    {
        ...
        ImGui::PlotLines("LineStrip", values, IM_ARRAYSIZE(values), values_offset, "avg 0.0", -1.0f, 1.0f, ImVec2(0,80));
        ...
        ImGui::PlotLines("LineStrip", func, NULL, display_count, 0, NULL, -1.0f, 1.0f, ImVec2(0,80));
...
static void ShowDemoWindowLayout()
{
    ...
    {
        HelpMarker("This is testing the vertical alignment that gets applied on text to keep it aligned with widgets. LineStrip only composed of text or \"small\" widgets fit in less vertical spaces than lines with normal widgets.");
    ...
    if (ImGui::TreeNode("Horizontal Scrolling"))
    {
        ...
        static int lines = 7;
        ImGui::SliderInt("LineStrip", &lines, 1, 15);
...
static void ShowDemoWindowMisc()
{
    ...
    if (ImGui::CollapsingHeader("Inputs, Navigation & Focus"))
    {
        ...
        if (ImGui::TreeNode("Keyboard, Mouse & Navigation EngineState"))
        {
...
static void ShowExampleAppConstrainedResize(bool* p_open)
{
    ...
    if (ImGui::Begin("Example: Constrained Resize", p_open, flags))
    {
        ...
        ImGui::SetNextItemWidth(200);
        ImGui::DragInt("LineStrip", &display_lines, 0.2f, 1, 100);
